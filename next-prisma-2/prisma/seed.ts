...
async function main() {
    const cocktails = [
        ...
        { name: "Rum Runner", imageUrl:"https://www.google.com/url?sa=i&url=https%3A%2F%2Fcookingwithcurls.com%2F2020%2F06%2F25%2Frum-runner-cocktail%2F&psig=AOvVaw1nPD3gl1DDApzPZAwOB0-U&ust=1761408908585000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCKDI3dSdvZADFQAAAAAdAAAAABAE", ingredients: "Rums, banana liqueur, berry liqueur, pineapple juice, grenadine" },
        ...
        { name: "Watermelon Cooler", imageUrl:"", ingredients: "Vodka, watermelon, lime, sugar, soda" },
